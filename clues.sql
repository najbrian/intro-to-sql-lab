...
FROM countries
JOIN countrylanguages ON countries.code = countrylanguages.countrycode
WHERE region = 'Southern Europe' AND countrylanguages.language = 'Italian' ORDER BY countries.name ASC;
...
FROM countries
JOIN cities on countries.code = cities.countrycode
WHERE cities.name LIKE 'Serr%' and countries.continent = 'South America';
